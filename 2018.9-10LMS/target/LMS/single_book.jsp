						...
						<ul class="nav navbar-nav navbar-left cl-effect-15">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									<li>
										<a href="shop.html">book catalog</a>
									</li>
									<li>
			...
			<div class="container">
				<div class="row">
					<ul class="btn-group btn-breadcrumb bc-list">
						...
						<li class="btn btn3">
							<a href="single_product.html">Single book</a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="occasion-cart">
						<div class="chr single-item single_page_b">
							<form action="#" method="post">
								...
								<button type="submit" class="chr-cart pchr-cart"> Borrow</button>
