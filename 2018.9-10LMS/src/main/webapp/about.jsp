                ...
                <div class="team-row">
                    ...
                    <div class="col-md-5 team-grid-left">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                            <div class="team-effect">
                                <img src="images/team1.jpg" alt="img" class="img-responsive" style="width: 260px; height: 260px;">
                                <div class="social-icon">
                                    <a href="https://github.com" class="social-button facebook">
                            ...
                            <div class="team-text">
                                ...
                                <p>Although the work is trivial, don't feel frustrated because you are carrying a small librarian. You can read more near the water tower!</p>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                            ...
                            <div class="team-effect">
                                <img src="images/team2.jpg" alt="img" class="img-responsive" style="width: 260px; height: 260px;">
                                <div class="social-icon">
                                    <a href="https://github.com" class="social-button twitter">
                                        <i class="fa fa-github-alt"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-5 team-grid-right">
                        <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                            ...
                            <div class="team-effect">
                                <img src="images/team3.JPG" alt="img" class="img-responsive" style="width: 260px; height: 260px;">
                                <div class="social-icon">
                                    <a href="https://github.com" class="social-button twitter">
                                        <i class="fa fa-github-alt"></i>
                                    </a>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 team-grids">
                            <div class="team-effect">
                                <img src="images/team4.jpg" alt="img" class="img-responsive" style="width: 260px; height: 260px;">
                                <div class="social-icon">
                                    <a href="https://github.com/Nepent" class="social-button twitter">
                                        <i class="fa fa-github-alt"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6 contact-foot text-right">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="mailto:ranjin@hotmail.com">ranjin898@hotmail.com</a>
                            </li>
                        </ul>
                    </div>
                    <!-- //footer-grid4 -->
