            ...
            <div class="container">
                ...
                <div class="col-md-7 about-left-grid">
                    <div class="inner-about2">
                      <h4> 60 seconds to read the world (News)</h4>
<%String news=(String)request.getSession().getAttribute(RequestAttribute.NEWS_SESSION); %>
<p style="font-size:12px;"><%=news %>
<!-- 1, the first case of illegal acquisition of citizens' information in the whole country was broken: 100 thousand owners' information was leaked.<br>
<br>
2, LETV: the highest loss in the first half is 1 billion 110 million yuan, and there is a risk of delisting.<br>
<br>
3. The riot cartoon exclusively responds to "Don Maju" (the actor Li Di) accusation: pay Li Di's performance fee monthly;<br>
<br>
4, Unicom's largest effort to reduce international / Hong Kong, Macao and Taiwan roaming charges: the biggest drop of 97%;<br>
<br>
5. The two ministries and commissions issued a three-year plan of action for the upgrading of information consumption: by 2020, the scale of information consumption will increase by more than 11% annually in an average of 6 trillion yuan;
<br>
<br>
6, land disputes in Huaxian, Henan: more than one official in the occupied enterprises will win the farmland.
<br>
<br>
7, Japanese media: the United States impose tariffs on China will affect its own consumption, the United States has a strong objection.
<br>
<br>
8, Hainan rectification of artificial reclamation Island: Land prohibition of pure commercial housing construction;
<br>
<br>
9, express delivery: some individual franchisees and outlets have taken disciplinary measures against fraud.
<br>
<br>
10, CAAC: since this year, 5 general aviation accidents have occurred in civil aviation, and 9 people have died. -->
</p>
                    </div>
