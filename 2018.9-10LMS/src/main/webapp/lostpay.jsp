		...
		<div class="innerf-pages section">
			<div class="container">
				<div class="privacy about">
					...
					<%int book_id=(Integer)request.getSession().getAttribute(RequestAttribute.ID2_SESSION); %>
					<%BookModel book=BookService.getBook3(book_id); %>
					<h3>You need to pay $<%=book.getPrice() %> .</h3>
					<br>
										...
										<form action="<%=UrlConstant.BOOK_SERVLET %>" method="post" class="creditly-card-form shopf-sear-headinfo_form">
												<section class="creditly-wrapper payf_wrapper">
													<div class="credit-card-wrapper">
														...
														<input class="payment" type="submit" name="submit" value="Completion" style="float:right;margin-top: 369px;margin-right:150px;"/>
															</div>
