        ...
        <div class="innerf-pages section">
            <div class="container">
                <div class="privacy about">
                   ...
                   <%List<ReserveModel> bookList=BookService.getAllBook3(user_name); %>
                ...
                %>
                    ...
                    <div class="checkout-right">
                        <table class="timetable_sub table-responsive">
                            ...
                            <%int no=1; %>
                            <%for(ReserveModel model: bookList){ %>
                           
                                <tr class="rem1">
                                    <td class="invert"><%=no %></td>
                                    <td class="invert-image"><input type="hidden" name="img" value="<%=model.getImg()%>"/>
									...
									<input type="hidden" name="bookname" value="<%=model.getBookname()%>"/><%=model.getBookname() %></td>
                                    <td class="invert"><input type="hidden" name="author" value="<%=model.getAuthor() %>"/><%=model.getAuthor() %></td>
                                    <td class="invert"><input type="hidden" name="remain" value="<%=model.getRemain()%>"><%=model.getRemain() %></td>
                                     <td class="invert"><%=model.getDate() %><input type="hidden" name="date" value="<%=model.getDate()%>"/></td>
                                     
                                    <td class="invert">
                                        <div class="rem">
                                        
                                           <input id="button_id" type="submit" name="submit" value="BORROW" class="chr-cart pchr-cart"/>
                                           <%if(model.getRemain().equals("0")){ %>
